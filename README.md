# Regex-Figure-Number
# 図表番号の書式を統一するための正規表現  <br>(Regular expressions to unify the format of figure numbers)  
初回投稿日：2025年1月30日  
最終更新日：2025年2月2日  
...
例えば、${4:+-$5} はキャプチャグループ4が存在する場合、-（ハイフン）とキャプチャグループ5 を使用するという意味になります。
